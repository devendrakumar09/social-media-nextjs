    ...
    <>
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm p-5 shadow-md  bg-white rounded-md">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm ">
          ...
          <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Create New Password</h2>
        </div>
        <form className="space-y-6 mt-10" action="#" method="POST">
          ...
          <div>
            <button type="submit" 
            className="mt-5 tracking-wide font-semibold bg-indigo-500 text-gray-100 w-full py-4 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">Sign in</button>
          </div>
        </form>
